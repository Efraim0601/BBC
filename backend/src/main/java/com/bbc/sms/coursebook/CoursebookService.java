...
public class CoursebookService {
    ...
    public CoursebookService(CoursebookRepository repo, AccessScopeService accessScope, JdbcTemplate jdbc) {
        this.repo = repo;
    ...
    public List<EntryView> forClass(String className) {
        ...
        accessScope.assertClassName(className.trim());
    ...
    public EntryView create(EntryUpsert in) {
        accessScope.assertClassName(in.className());
        UUID schoolId = TenantContext.get();
    ...
    public EntryView update(UUID id, EntryUpsert in) {
        ...
        accessScope.assertClassName(e.getClassName());
        accessScope.assertClassName(in.className());
        apply(e, in, schoolId);
        return toView(repo.save(e), subjectLabels(schoolId));
    }
