...
public class ProductionBootstrap implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        grants(schoolId, "principal", "read", "dashboard", "presence", "students", "hr", "academic",
            ...
            "alerts", "messages", "coursebook", "health", "documents", "classkit", "promotion", "library");
        ...
        grants(schoolId, "teacher", "read", "dashboard", "presence", "students", "timetable", "events", "messages", "library");
        grants(schoolId, "secondary_teacher", "write", "academic", "coursebook");
        grants(schoolId, "secondary_teacher", "read", "dashboard", "presence", "students", "timetable", "events", "messages", "library");
