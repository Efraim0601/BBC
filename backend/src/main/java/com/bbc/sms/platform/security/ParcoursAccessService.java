 ...
 *
 * <p>Le rôle d'admin de section (cf. {@link SectionRoles}) prime sur le mode :
 * c'est un verrou déduit du rôle, que nulle colonne ne desserre.
 */
@Service("parcours")
public class ParcoursAccessService {
    ...
    public List<Scope> allowed(UUID userId) {
        // Un admin de section règne sur les deux sous-systèmes de son cycle, et
        // sur eux seuls. Ce verrou prime sur le mode de portée : il découle du
        // rôle, on ne le desserre pas par une table ni par une colonne.
