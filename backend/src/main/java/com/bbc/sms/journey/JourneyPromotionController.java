...
public class JourneyPromotionController {
    ...
    @GetMapping("/paths")
    @PreAuthorize("@policy.canAction('PROGRESSION_VIEW')")
    ...
    @PostMapping("/paths")
    @PreAuthorize("@policy.canAction('PROGRESSION_CONFIGURE')")
    ...
    @PreAuthorize("@policy.canAction('PROMOTION_CONFIGURE')")
    ...
    @PreAuthorize("@policy.canAction('PROMOTION_RECOMMEND')")
    ...
    @PreAuthorize("@policy.canAction('PROMOTION_REVIEW')")
    ...
    @PreAuthorize("@policy.canAction('PROMOTION_COMMIT')")
    ...
    @PreAuthorize("@policy.canAction('PROMOTION_OVERRIDE')")
