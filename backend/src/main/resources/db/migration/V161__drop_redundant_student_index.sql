-- ============================================================================
--  V161 — Retrait des deux index ajoutés à tort par V160
--
--  V160 créait `idx_student_class_roster` et `idx_student_school_niu` en partant
...
--  V160 n'est pas modifiée : sa somme de contrôle est déjà enregistrée en base.
-- ============================================================================
