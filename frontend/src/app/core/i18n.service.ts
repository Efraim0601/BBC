...
const DICT: Record<string, { fr: string; en: string }> = {
  ...
  'finance-accounting': { fr: 'Comptabilité', en: 'Accounting' },
  'finance-fee-types': { fr: 'Types de frais', en: 'Fee types' },
  'finance-plans': { fr: 'Plans de frais', en: 'Fee plans' },
  'finance-charges': { fr: 'Charges & débiteurs', en: 'Charges & debtors' },
  'finance-collections': { fr: 'Encaissements & caisse', en: 'Collections & cashier' },
  'finance-reports': { fr: 'Rapports financiers', en: 'Finance reports' },
