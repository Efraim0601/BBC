  ...
  template: `
    ...
    @if (overrideCandidate(); as c) {
      <div class="fixed inset-0 z-50 bg-slate-950/40 flex items-center justify-center p-4" (click)="closeOverride()">
        <div class="max-h-[calc(100dvh-2rem)] overflow-y-auto bg-white rounded-2xl shadow-xl border border-slate-200 w-full max-w-lg p-5" (click)="$event.stopPropagation()">
